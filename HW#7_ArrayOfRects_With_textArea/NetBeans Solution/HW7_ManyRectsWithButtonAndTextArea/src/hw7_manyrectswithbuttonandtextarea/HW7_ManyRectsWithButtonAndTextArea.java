// Many Rects With Button / TextArea
// Blake Conrad
package hw7_manyrectswithbuttonandtextarea;
...
public class HW7_ManyRectsWithButtonAndTextArea extends JFrame{
	...
	public static void main(String[] args) {
		new HW7_ManyRectsWithButtonAndTextArea();
	}
	public HW7_ManyRectsWithButtonAndTextArea(){
		//go_menu_no_gui();
		setup();
	}
